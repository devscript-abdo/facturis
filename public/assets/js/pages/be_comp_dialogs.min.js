Facturis.onLoad(() =>
    class {
        static sweetAlert2() {
            let e = Swal.mixin({ buttonsStyling: !1, target: "#page-container", customClass: { confirmButton: "btn btn-success m-1", cancelButton: "btn btn-danger m-1", input: "form-control" } });
            document.querySelector(".js-swal-simple").addEventListener("click", (t) => {
                ...
                document.querySelector(".js-swal-custom-position").addEventListener("click", (t) => {
                    e.fire({ position: "top-end", title: "Perfect!", text: "Nice Position!", icon: "success" });
                });
        }
        static init() {
            this.sweetAlert2();
