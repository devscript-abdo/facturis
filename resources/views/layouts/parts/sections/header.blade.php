<div id="facturis_app_header" class="app-header">
    <!--facturisStart::Header container-->
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        id="facturis_app_header_container">
        <!--facturisStart::sidebar mobile toggle-->
        <div class="d-flex align-items-center d-lg-none ms-n2 me-2" title="Show sidebar menu">
            <div class="btn btn-icon btn-active-color-primary w-35px h-35px" id="facturis_app_sidebar_mobile_toggle">
                <!--facturisStart::Svg Icon | path: icons/duotune/abstract/abs015.svg-->
        ...
        <!--facturisStart::Header wrapper-->
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="facturis_app_header_wrapper">
            <!--facturisStart::Menu wrapper-->
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-facturis-drawer="true"
                data-facturis-drawer-name="app-header-menu" data-facturis-drawer-activate="{default: true, lg: false}"
                data-facturis-drawer-overlay="true" data-facturis-drawer-width="250px"
                data-facturis-drawer-direction="end" data-facturis-drawer-toggle="#facturis_app_header_menu_toggle"
                data-facturis-swapper="true" data-facturis-swapper-mode="{default: 'append', lg: 'prepend'}"
                data-facturis-swapper-parent="{default: '#facturis_app_body', lg: '#facturis_app_header_wrapper'}">
                <!--facturisStart::Menu-->
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
                    id="facturis_app_header_menu" data-facturis-menu="true">
                    <!--begin:Menu item-->
                    <div data-facturis-menu-trigger="{default: 'click', lg: 'hover'}"
                        data-facturis-menu-placement="bottom-start"
                        ...
                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0 w-100 w-lg-850px">
                            ...
                            <div class="menu-state-bg menu-extended overflow-hidden" data-facturis-menu-dismiss="true">
                                <!--begin:Row-->
                                <div class="row">
                                    <!--begin:Col-->
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    ...
                                                    <a href="../../demo1/dist/dashboards/ecommerce.html"
                                                        ...
                                                        <span
                                                            class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                            <!--facturisStart::Svg Icon | path: icons/duotune/ecommerce/ecm002.svg-->
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    ...
                                                    <a href="../../demo1/dist/dashboards/projects.html"
                                                        ...
                                                        <span
                                                            class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                            <!--facturisStart::Svg Icon | path: icons/duotune/abstract/abs045.svg-->
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    ...
                                                    <a href="../../demo1/dist/dashboards/online-courses.html"
                                                        ...
                                                        <span
                                                            class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                            <!--facturisStart::Svg Icon | path: icons/duotune/art/art002.svg-->
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    ...
                                                    <a href="../../demo1/dist/dashboards/marketing.html"
                                                        ...
                                                        <span
                                                            class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                            <!--facturisStart::Svg Icon | path: icons/duotune/graphs/gra001.svg-->
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    ...
                                                    <a href="../../demo1/dist/dashboards/bidding.html"
                                                        ...
                                                        <span
                                                            class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                            <!--facturisStart::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    ...
                                                    <a href="../../demo1/dist/dashboards/pos.html" class="menu-link">
                                                        <span
                                                            class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                            <!--facturisStart::Svg Icon | path: icons/duotune/abstract/abs043.svg-->
                                                            <span class="svg-icon svg-icon-danger svg-icon-1">
                                                                <svg width="24" height="24"
                                                                    viewBox="0 0 24 24" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    ...
                                                    <a href="../../demo1/dist/dashboards/call-center.html"
                                                        ...
                                                        <span
                                                            class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                            <!--facturisStart::Svg Icon | path: icons/duotune/communication/com004.svg-->
                                                            <span class="svg-icon svg-icon-primary svg-icon-1">
                                                                <svg width="24" height="24"
                                                                    viewBox="0 0 24 24" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="menu-active-bg px-4 px-lg-0">
                                    ...
                                    <ul
                                        ...
                                        <li class="nav-item mx-lg-1">
                                            <a class="nav-link py-3 py-lg-6 active text-active-primary" href="#"
                                                data-bs-toggle="tab"
                                                data-bs-target="#facturis_app_header_menu_pages_pages">General</a>
                                        </li>
                                        <!--end:Nav item-->
                                        <!--begin:Nav item-->
                                        <li class="nav-item mx-lg-1">
                                            <a class="nav-link py-3 py-lg-6 text-active-primary" href="#"
                                                data-bs-toggle="tab"
                                                data-bs-target="#facturis_app_header_menu_pages_account">Account</a>
                                        </li>
                                        <!--end:Nav item-->
                                        <!--begin:Nav item-->
                                        <li class="nav-item mx-lg-1">
                                            <a class="nav-link py-3 py-lg-6 text-active-primary" href="#"
                                                data-bs-toggle="tab"
                                                data-bs-target="#facturis_app_header_menu_pages_authentication">Authentication</a>
                                        </li>
                                        <!--end:Nav item-->
                                        <!--begin:Nav item-->
                                        <li class="nav-item mx-lg-1">
                                            <a class="nav-link py-3 py-lg-6 text-active-primary" href="#"
                                                data-bs-toggle="tab"
                                                data-bs-target="#facturis_app_header_menu_pages_utilities">Utilities</a>
                                        </li>
                                        <!--end:Nav item-->
                                        <!--begin:Nav item-->
                                        <li class="nav-item mx-lg-1">
                                            <a class="nav-link py-3 py-lg-6 text-active-primary" href="#"
                                                data-bs-toggle="tab"
                                                data-bs-target="#facturis_app_header_menu_pages_widgets">Widgets</a>
                                        </li>
                                        <!--end:Nav item-->
                                    </ul>
                                </div>
                                ...
                                <div class="tab-content py-4 py-lg-8 px-lg-7">
                                    ...
                                    <div class="tab-pane active w-lg-1000px"
                                        id="facturis_app_header_menu_pages_pages">
                                        <!--begin:Row-->
                                        <div class="row">
                                            <!--begin:Col-->
                                            <div class="col-lg-8">
                                    ...
                                    <!--end:Tab pane-->
                                    <!--begin:Tab pane-->
                                    <div class="tab-pane w-lg-600px" id="facturis_app_header_menu_pages_account">
                                        <!--begin:Row-->
                                        <div class="row">
                                            <!--begin:Col-->
                                    ...
                                    <div class="tab-pane w-lg-1000px"
                                        id="facturis_app_header_menu_pages_authentication">
                                        <!--begin:Row-->
                                        <div class="row">
                                            <!--begin:Col-->
                                            <div class="col-lg-3 mb-6 mb-lg-0">
                                    ...
                                    <!--end:Tab pane-->
                                    <!--begin:Tab pane-->
                                    <div class="tab-pane w-lg-1000px" id="facturis_app_header_menu_pages_utilities">
                                        <!--begin:Row-->
                                        <div class="row">
                                            <!--begin:Col-->
                                            <div class="col-lg-7">
                                    ...
                                    <!--end:Tab pane-->
                                    <!--begin:Tab pane-->
                                    <div class="tab-pane w-lg-500px" id="facturis_app_header_menu_pages_widgets">
                                        <!--begin:Row-->
                                        <div class="row">
                                            <!--begin:Col-->
                                            <div class="col-lg-4 mb-6 mb-lg-0">
                    ...
                    <div data-facturis-menu-trigger="{default: 'click', lg: 'hover'}"
                        ...
                        <div
                            ...
                            <!--begin:Menu item-->
                            <div data-facturis-menu-trigger="{default:'click', lg: 'hover'}"
                                data-facturis-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                <!--begin:Menu link-->
                                <span class="menu-link">
                            ...
                            <div data-facturis-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <span class="menu-link">
                                    <span class="menu-icon">
                                        <!--facturisStart::Svg Icon | path: icons/duotune/ecommerce/ecm001.svg-->
                                        <span class="svg-icon svg-icon-3">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.3"
                                ...
                                <div
                                    ...
                                    <!--begin:Menu item-->
                                    <div data-facturis-menu-trigger="{default:'click', lg: 'hover'}"
                                        data-facturis-menu-placement="right-start"
                                    ...
                                    <!--end:Menu item-->
                                    <!--begin:Menu item-->
                                    <div data-facturis-menu-trigger="click"
                            ...
                            <div data-facturis-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <span class="menu-link">
                                    <span class="menu-icon">
                                        <!--facturisStart::Svg Icon | path: icons/duotune/graphs/gra006.svg-->
                                        <span class="svg-icon svg-icon-3">
                                            <svg width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            <div data-facturis-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <span class="menu-link">
                                    <span class="menu-icon">
                                        <!--facturisStart::Svg Icon | path: icons/duotune/general/gen051.svg-->
                                        <span class="svg-icon svg-icon-3">
                                            <svg width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.3"
                            ...
                            <div data-facturis-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <span class="menu-link">
                                    <span class="menu-icon">
                                        <!--facturisStart::Svg Icon | path: icons/duotune/electronics/elc002.svg-->
                                        <span class="svg-icon svg-icon-3">
                                            <svg width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div data-facturis-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <span class="menu-link">
                                    <span class="menu-icon">
                                        <!--facturisStart::Svg Icon | path: icons/duotune/finance/fin006.svg-->
                                        <span class="svg-icon svg-icon-3">
                                            <svg width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.3"
                            ...
                            <div data-facturis-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <span class="menu-link">
                                    <span class="menu-icon">
                                        <!--facturisStart::Svg Icon | path: icons/duotune/finance/fin002.svg-->
                                        <span class="svg-icon svg-icon-3">
                                            <svg width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div data-facturis-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <span class="menu-link">
                                    <span class="menu-icon">
                                        <!--facturisStart::Svg Icon | path: icons/duotune/files/fil025.svg-->
                                        <span class="svg-icon svg-icon-3">
                                            <svg width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.3"
                            ...
                            <div data-facturis-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <span class="menu-link">
                                    <span class="menu-icon">
                                        <!--facturisStart::Svg Icon | path: icons/duotune/communication/com011.svg-->
                                        <span class="svg-icon svg-icon-3">
                                            <svg width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.3"
                            ...
                            <div data-facturis-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <span class="menu-link">
                                    <span class="menu-icon">
                                        <!--facturisStart::Svg Icon | path: icons/duotune/communication/com012.svg-->
                                        <span class="svg-icon svg-icon-3">
                                            <svg width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.3"
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link" href="../../demo1/dist/apps/calendar.html">
                                    <span class="menu-icon">
                                        <!--facturisStart::Svg Icon | path: icons/duotune/general/gen014.svg-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div
                                            ...
                                            <a href="https://preview.keenthemes.com/Facturis8/layout-builder.html"
                    ...
                    <div data-facturis-menu-trigger="{default: 'click', lg: 'hover'}"
                        ...
                        <div
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link"
                                    href="https://preview.keenthemes.com/html/Facturis/docs/base/utilities"
                                    target="blank"
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="https://preview.keenthemes.com/html/Facturis/docs"
                                    target="blank" title="Check out the complete documentation"
                                    data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                                    data-bs-placement="right">
                                    <span class="menu-icon">
                                        <!--facturisStart::Svg Icon | path: icons/duotune/abstract/abs027.svg-->
                                        <span class="svg-icon svg-icon-3">
                                            <svg width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.3"
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link"
                                    href="https://preview.keenthemes.com/html/Facturis/docs/getting-started/changelog"
                                    target="blank">
                                    <span class="menu-icon">
                                        <!--facturisStart::Svg Icon | path: icons/duotune/coding/cod003.svg-->
                                        <span class="svg-icon svg-icon-3">
                                            <svg width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
            ...
            <!--facturisEnd::Menu wrapper-->
            <!--facturisStart::Navbar-->
            <div class="app-navbar flex-shrink-0">
                <!--facturisStart::Search-->
                <div class="app-navbar-item align-items-stretch ms-1 ms-lg-3">
                    <!--facturisStart::Search-->
                    <div id="facturis_id_header_search" class="header-search d-flex align-items-stretch"
                        data-facturis-search-keypress="true" data-facturis-search-min-length="2"
                        data-facturis-search-enter="enter" data-facturis-search-layout="menu"
                        data-facturis-menu-trigger="auto" data-facturis-menu-overflow="false"
                        data-facturis-menu-permanent="true" data-facturis-menu-placement="bottom-end">
                        <!--facturisStart::Search toggle-->
                        <div class="d-flex align-items-center" data-facturis-search-element="toggle"
                            id="facturis_id_header_search_toggle">
                            <div
                                class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px">
                                <!--facturisStart::Svg Icon | path: icons/duotune/general/gen021.svg-->
                                <span class="svg-icon svg-icon-1">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                        ...
                        <!--facturisEnd::Search toggle-->
                        <!--facturisStart::Menu-->
                        <div data-facturis-search-element="content"
                            class="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px">
                            <!--facturisStart::Wrapper-->
                            <div data-facturis-search-element="wrapper">
                                <!--facturisStart::Form-->
                                <form data-facturis-search-element="form" class="w-100 position-relative mb-3"
                                    autocomplete="off">
                                    <!--facturisStart::Icon-->
                                    <!--facturisStart::Svg Icon | path: icons/duotune/general/gen021.svg-->
                                    <span
                                    ...
                                    <input type="text" class="search-input form-control form-control-flush ps-10"
                                        ...
                                        data-facturis-search-element="input" />
                                    <!--facturisEnd::Input-->
                                    <!--facturisStart::Spinner-->
                                    <span class="position-absolute top-50 end-0 translate-middle-y lh-0 d-none me-1"
                                        data-facturis-search-element="spinner">
                                    ...
                                    <span
                                        ...
                                        data-facturis-search-element="clear">
                                    ...
                                    <!--facturisEnd::Reset-->
                                    <!--facturisStart::Toolbar-->
                                    <div class="position-absolute top-50 end-0 translate-middle-y"
                                        data-facturis-search-element="toolbar">
                                        <!--facturisStart::Preferences toggle-->
                                        <div data-facturis-search-element="preferences-show"
                                            class="btn btn-icon w-20px btn-sm btn-active-color-primary me-1"
                                            data-bs-toggle="tooltip" title="Show search preferences">
                                            <!--facturisStart::Svg Icon | path: icons/duotune/coding/cod001.svg-->
                                            <span class="svg-icon svg-icon-1">
                                                <svg width="24" height="24" viewBox="0 0 24 24"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path opacity="0.3"
                                        ...
                                        <!--facturisEnd::Preferences toggle-->
                                        <!--facturisStart::Advanced search toggle-->
                                        <div data-facturis-search-element="advanced-options-form-show"
                                        ...
                                        <!--facturisEnd::Advanced search toggle-->
                                    </div>
                                    <!--facturisEnd::Toolbar-->
                                </form>
                                <!--facturisEnd::Form-->
                                ...
                                <!--facturisStart::Recently viewed-->
                                <div data-facturis-search-element="results" class="d-none">
                                    <!--facturisStart::Items-->
                                    <div class="scroll-y mh-200px mh-lg-350px">
                                        <!--facturisStart::Category title-->
                                        <h3 class="fs-5 text-muted m-0 pb-5"
                                            data-facturis-search-element="category-title">Users</h3>
                                        <!--facturisEnd::Category title-->
                                        <!--facturisStart::Item-->
                                        <a href="#"
                                        ...
                                        <h3 class="fs-5 text-muted m-0 pt-5 pb-5"
                                            data-facturis-search-element="category-title">Customers</h3>
                                        <!--facturisEnd::Category title-->
                                        <!--facturisStart::Item-->
                                        <a href="#"
                                            class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        ...
                                        <!--facturisStart::Category title-->
                                        <h3 class="fs-5 text-muted m-0 pt-5 pb-5"
                                            data-facturis-search-element="category-title">Projects</h3>
                                        <!--facturisEnd::Category title-->
                                        <!--facturisStart::Item-->
                                        <a href="#"
                                            class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <!--facturisStart::Svg Icon | path: icons/duotune/general/gen005.svg-->
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <!--facturisStart::Svg Icon | path: icons/duotune/general/gen032.svg-->
                                                    <span class="svg-icon svg-icon-2 svg-icon-primary">
                                                        <svg width="24" height="24" viewBox="0 0 24 24"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <!--facturisStart::Svg Icon | path: icons/duotune/communication/com006.svg-->
                                                    <span class="svg-icon svg-icon-2 svg-icon-primary">
                                ...
                                <!--facturisEnd::Recently viewed-->
                                <!--facturisStart::Recently viewed-->
                                <div class="mb-5" data-facturis-search-element="main">
                                    ...
                                    <div class="scroll-y mh-200px mh-lg-325px">
                                        ...
                                        <div class="d-flex align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <!--facturisStart::Svg Icon | path: icons/duotune/electronics/elc004.svg-->
                                                    <span class="svg-icon svg-icon-2 svg-icon-primary">
                                                        <svg width="24" height="24" viewBox="0 0 24 24"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                        ...
                                        <div class="d-flex align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <!--facturisStart::Svg Icon | path: icons/duotune/graphs/gra002.svg-->
                                                    <span class="svg-icon svg-icon-2 svg-icon-primary">
                                                        <svg width="24" height="24" viewBox="0 0 24 24"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="d-flex align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <!--facturisStart::Svg Icon | path: icons/duotune/communication/com010.svg-->
                                                    <span class="svg-icon svg-icon-2 svg-icon-primary">
                                                        <svg width="24" height="24" viewBox="0 0 24 24"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                        ...
                                        <div class="d-flex align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <!--facturisStart::Svg Icon | path: icons/duotune/finance/fin001.svg-->
                                                    <span class="svg-icon svg-icon-2 svg-icon-primary">
                                                        <svg width="24" height="24" viewBox="0 0 24 24"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                ...
                                <!--facturisEnd::Recently viewed-->
                                <!--facturisStart::Empty-->
                                <div data-facturis-search-element="empty" class="text-center d-none">
                                    <!--facturisStart::Icon-->
                                    <div class="pt-10 pb-10">
                                        <!--facturisStart::Svg Icon | path: icons/duotune/files/fil024.svg-->
                            ...
                            <!--facturisEnd::Wrapper-->
                            <!--facturisStart::Preferences-->
                            <form data-facturis-search-element="advanced-options-form" class="pt-1 d-none">
                                <!--facturisStart::Heading-->
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="reset"
                                        ...
                                        data-facturis-search-element="advanced-options-form-cancel">Cancel</button>
                                    <a href="../../demo1/dist/pages/search/horizontal.html"
                                        class="btn btn-sm fw-bold btn-primary"
                                        data-facturis-search-element="advanced-options-form-search">Search</a>
                                </div>
                                <!--facturisEnd::Actions-->
                            </form>
                            <!--facturisEnd::Preferences-->
                            <!--facturisStart::Preferences-->
                            <form data-facturis-search-element="preferences" class="pt-1 d-none">
                                <!--facturisStart::Heading-->
                                ...
                                <div class="d-flex justify-content-end pt-7">
                                    <button type="reset"
                                        class="btn btn-sm btn-light fw-bold btn-active-light-primary me-2"
                                        data-facturis-search-element="preferences-dismiss">Cancel</button>
                ...
                <!--facturisEnd::Search-->
                <!--facturisStart::Activities-->
                <div class="app-navbar-item ms-1 ms-lg-3">
                    <!--facturisStart::Drawer toggle-->
                    <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px"
                        id="facturis_id_activities_toggle">
                        <!--facturisStart::Svg Icon | path: icons/duotune/general/gen032.svg-->
                        <span class="svg-icon svg-icon-1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!--facturisEnd::Drawer toggle-->
                </div>
                <!--facturisEnd::Activities-->
                <!--facturisStart::Notifications-->
                <div class="app-navbar-item ms-1 ms-lg-3">
                    <!--facturisStart::Menu- wrapper-->
                    <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px"
                        ...
                        <!--facturisStart::Svg Icon | path: icons/duotune/general/gen022.svg-->
                        <span class="svg-icon svg-icon-1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
                            ...
                            <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9">
                                <li class="nav-item">
                                    <a class="nav-link text-white opacity-75 opacity-state-100 pb-4"
                                        data-bs-toggle="tab" href="#facturis_id_topbar_notifications_1">Alerts</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-white opacity-75 opacity-state-100 pb-4 active"
                                        data-bs-toggle="tab" href="#facturis_id_topbar_notifications_2">Updates</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-white opacity-75 opacity-state-100 pb-4"
                                        data-bs-toggle="tab" href="#facturis_id_topbar_notifications_3">Logs</a>
                                </li>
                            </ul>
                            <!--facturisEnd::Tabs-->
                        </div>
                        <!--facturisEnd::Heading-->
                        <!--facturisStart::Tab content-->
                        <div class="tab-content">
                            <!--facturisStart::Tab panel-->
                            <div class="tab-pane fade" id="facturis_id_topbar_notifications_1" role="tabpanel">
                                <!--facturisStart::Items-->
                                <div class="scroll-y mh-325px my-5 px-8">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-35px me-4">
                                                <span class="symbol-label bg-light-primary">
                                                    <!--facturisStart::Svg Icon | path: icons/duotune/technology/teh008.svg-->
                                                    <span class="svg-icon svg-icon-2 svg-icon-primary">
                                                        <svg width="24" height="24" viewBox="0 0 24 24"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path opacity="0.3"
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-35px me-4">
                                                <span class="symbol-label bg-light-danger">
                                                    <!--facturisStart::Svg Icon | path: icons/duotune/general/gen044.svg-->
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-35px me-4">
                                                <span class="symbol-label bg-light-success">
                                                    <!--facturisStart::Svg Icon | path: icons/duotune/files/fil023.svg-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-35px me-4">
                                                <span class="symbol-label bg-light-primary">
                                                    <!--facturisStart::Svg Icon | path: icons/duotune/maps/map001.svg-->
                                                    <span class="svg-icon svg-icon-2 svg-icon-primary">
                                                        <svg width="24" height="24" viewBox="0 0 24 24"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path opacity="0.3"
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-35px me-4">
                                                <span class="symbol-label bg-light-info">
                                                    <!--facturisStart::Svg Icon | path: icons/duotune/general/gen006.svg-->
                                ...
                                <!--facturisEnd::Items-->
                                <!--facturisStart::View more-->
                                <div class="py-3 text-center border-top">
                                    <a href="../../demo1/dist/pages/user-profile/activity.html"
                                        class="btn btn-color-gray-600 btn-active-color-primary">View All
                                        <!--facturisStart::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
                                ...
                                <!--facturisEnd::View more-->
                            </div>
                            <!--facturisEnd::Tab panel-->
                            <!--facturisStart::Tab panel-->
                            <div class="tab-pane fade show active" id="facturis_id_topbar_notifications_2"
                                role="tabpanel">
                                <!--facturisStart::Wrapper-->
                                <div class="d-flex flex-column px-9">
                                    ...
                                    <div class="pt-10 pb-0">
                                        ...
                                        <!--facturisEnd::Text-->
                                        <!--facturisStart::Action-->
                                        <div class="text-center mt-5 mb-9">
                                            <a href="#" class="btn btn-sm btn-primary px-6"
                                                data-bs-toggle="modal"
                                                data-bs-target="#facturis_id_modal_upgrade_plan">Upgrade</a>
                                        </div>
                                        <!--facturisEnd::Action-->
                                    </div>
                                    <!--facturisEnd::Section-->
                            ...
                            <!--facturisEnd::Tab panel-->
                            <!--facturisStart::Tab panel-->
                            <div class="tab-pane fade" id="facturis_id_topbar_notifications_3" role="tabpanel">
                                <!--facturisStart::Items-->
                                <div class="scroll-y mh-325px my-5 px-8">
                                    <!--facturisStart::Item-->
                                    <div class="d-flex flex-stack py-4">
                        ...
                        <!--facturisEnd::Tab content-->
                    </div>
                    <!--facturisEnd::Menu-->
                    <!--facturisEnd::Menu wrapper-->
                </div>
                <!--facturisEnd::Notifications-->
                <!--facturisStart::Chat-->
                <div class="app-navbar-item ms-1 ms-lg-3">
                    <!--facturisStart::Menu wrapper-->
                    <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px position-relative"
                        id="facturis_id_drawer_chat_toggle">
                        <!--facturisStart::Svg Icon | path: icons/duotune/communication/com012.svg-->
                        <span class="svg-icon svg-icon-1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3">
                    ...
                    <!--facturisStart::My apps-->
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-100 w-sm-350px"
                        data-facturis-menu="true">
                        <!--facturisStart::Card-->
                        <div class="card">
                            <!--facturisStart::Card header-->
                            <div class="card-header">
                                <!--facturisStart::Card title-->
                                <div class="card-title">My Apps</div>
                                <!--facturisEnd::Card title-->
                                <!--facturisStart::Card toolbar-->
                                <div class="card-toolbar">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                        ...
                                        <!--facturisEnd::Menu item-->
                                        <!--facturisStart::Menu item-->
                                        <div class="menu-item px-3" data-facturis-menu-trigger="hover"
                                            data-facturis-menu-placement="right-end">
                                ...
                                <!--facturisEnd::Card toolbar-->
                            </div>
                            <!--facturisEnd::Card header-->
                            <!--facturisStart::Card body-->
                ...
                <!--facturisEnd::My apps links-->
                <!--facturisStart::Theme mode-->
                <div class="app-navbar-item ms-1 ms-lg-3">
                    ...
                    <a href="#"
                        ...
                        data-facturis-menu-trigger="{default:'click', lg: 'hover'}"
                        data-facturis-menu-attach="parent" data-facturis-menu-placement="bottom-end">
                        <!--facturisStart::Svg Icon | path: icons/duotune/general/gen060.svg-->
                        ...
                        <!--facturisEnd::Svg Icon-->
                        <!--facturisStart::Svg Icon | path: icons/duotune/general/gen061.svg-->
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-175px"
                        data-facturis-menu="true" data-facturis-element="theme-mode-menu">
                        <!--facturisStart::Menu item-->
                        <div class="menu-item px-3 my-0">
                            <a href="#" class="menu-link px-3 py-2" data-facturis-element="mode"
                                data-facturis-value="light">
                                <span class="menu-icon" data-facturis-element="icon">
                                    <!--facturisStart::Svg Icon | path: icons/duotune/general/gen060.svg-->
                                    <span class="svg-icon svg-icon-3">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="menu-item px-3 my-0">
                            <a href="#" class="menu-link px-3 py-2" data-facturis-element="mode"
                                data-facturis-value="system">
                                <span class="menu-icon" data-facturis-element="icon">
                                    <!--facturisStart::Svg Icon | path: icons/duotune/general/gen062.svg-->
                                    <span class="svg-icon svg-icon-3">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                ...
                <!--facturisEnd::Theme mode-->
                <!--facturisStart::User menu-->
                <div class="app-navbar-item ms-1 ms-lg-3" id="facturis_id_header_user_menu_toggle">
                    <!--facturisStart::Menu wrapper-->
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <!--facturisEnd::Menu item-->
                        <!--facturisStart::Menu item-->
                        <div class="menu-item px-5" data-facturis-menu-trigger="{default: 'click', lg: 'hover'}"
                            data-facturis-menu-placement="left-start" data-facturis-menu-offset="-15px, 0">
                ...
                <!--facturisEnd::User menu-->
                <!--facturisStart::Header menu toggle-->
                <div class="app-navbar-item d-lg-none ms-2 me-n3" title="Show header menu">
                    <div class="btn btn-icon btn-active-color-primary w-35px h-35px"
                        id="facturis_app_header_menu_toggle">
                        <!--facturisStart::Svg Icon | path: icons/duotune/text/txt001.svg-->
                        <span class="svg-icon svg-icon-1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <!--facturisEnd::Header menu toggle-->
            </div>
            <!--facturisEnd::Navbar-->
        </div>
        <!--facturisEnd::Header wrapper-->
    </div>
    <!--facturisEnd::Header container-->
</div>
