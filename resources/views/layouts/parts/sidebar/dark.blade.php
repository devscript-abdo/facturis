<div id="facturis_app_sidebar" class="app-sidebar flex-column" data-facturis-drawer="true"
    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="facturis_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#facturis_app_sidebar_menu"
                        ...
                        <div class="menu-item">
                            <div class="menu-content">
                                <a class="btn btn-flex btn-color-primary d-flex flex-stack fs-base p-0 ms-2 mb-2 toggle collapsible active"
                                    data-bs-toggle="collapse" href="#facturis_app_sidebar_menu_dashboards_collapse"
                                    data-facturis-toggle-text="Show 12 More">
                                    <span data-facturis-toggle-text-target="true">Show Less</span>
                                    <!--facturisStart::Svg Icon | path: icons/duotune/general/gen036.svg-->
                                    ...
                                    <!--facturisEnd::Svg Icon-->
                                    <!--facturisStart::Svg Icon | path: icons/duotune/general/gen035.svg-->
                ...
                <!--end:Menu item-->
                <!--begin:Menu item-->
                <div data-facturis-menu-trigger="click" class="menu-item menu-accordion">
                    <!--begin:Menu link-->
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--facturisStart::Svg Icon | path: icons/duotune/communication/com005.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                ...
                <div data-facturis-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--facturisStart::Svg Icon | path: icons/duotune/communication/com013.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                ...
                <div data-facturis-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--facturisStart::Svg Icon | path: icons/duotune/files/fil003.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.3"
                ...
                <div data-facturis-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--facturisStart::Svg Icon | path: icons/duotune/abstract/abs048.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.3"
                ...
                <div data-facturis-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--facturisStart::Svg Icon | path: icons/duotune/graphs/gra010.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                ...
                <div data-facturis-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--facturisStart::Svg Icon | path: icons/duotune/art/art007.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.3"
                ...
                <div data-facturis-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--facturisStart::Svg Icon | path: icons/duotune/layouts/lay008.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                ...
                <div data-facturis-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--facturisStart::Svg Icon | path: icons/duotune/abstract/abs042.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                ...
                <div data-facturis-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--facturisStart::Svg Icon | path: icons/duotune/abstract/abs026.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.3"
                ...
                <div data-facturis-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <!--end:Menu item-->
                        <!--begin:Menu item-->
                        <div data-facturis-menu-trigger="click" class="menu-item menu-accordion mb-1">
                            <!--begin:Menu link-->
                            <span class="menu-link">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                ...
                <div data-facturis-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--facturisStart::Svg Icon | path: icons/duotune/abstract/abs029.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                ...
                <div data-facturis-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--facturisStart::Svg Icon | path: icons/duotune/abstract/abs040.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                ...
                <div data-facturis-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--facturisStart::Svg Icon | path: icons/duotune/maps/map002.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                ...
                <div data-facturis-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--facturisStart::Svg Icon | path: icons/duotune/text/txt002.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link" href="https://preview.keenthemes.com/Facturis8/layout-builder.html">
                        <span class="menu-icon">
                            <!--facturisStart::Svg Icon | path: icons/duotune/abstract/abs014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.3"
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link" href="https://preview.keenthemes.com/html/Facturis/docs" target="blank">
                        <span class="menu-icon">
    ...
    <!--facturisEnd::sidebar menu-->
    <!--facturisStart::Footer-->
    <div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="facturis_app_sidebar_footer">
        <a href="https://preview.keenthemes.com/html/Facturis/docs"
