<div class="block block-rounded">
    <div class="block-content">
        <form action="be_pages_generic_profile_edit.html" method="POST" enctype="multipart/form-data"
                ...
                <div class="col-lg-8 col-xl-5">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" class="form-control" id="dm-profile-edit-email"
                            name="dm-profile-edit-email" placeholder="Enter your email.." value="john.doe@example.com">
                    </div>
                    <div class="mb-4">
