            ...
            <table class="table table-borderless table-striped table-vcenter">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="d-none d-sm-table-cell text-center fs-sm">20/07/2019</td>
                        <td class="d-none d-md-table-cell text-center fs-sm">
                            <a class="fw-semibold" href="javascript:void(0)">5</a>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="d-none d-sm-table-cell text-center fs-sm">08/05/2019</td>
                        <td class="d-none d-md-table-cell text-center fs-sm">
                    ...
                    <tr>
                        ...
                        <td class="d-none d-sm-table-cell text-center fs-sm">13/08/2019</td>
                        <td class="d-none d-md-table-cell text-center fs-sm">
                            <a class="fw-semibold" href="javascript:void(0)">7</a>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="d-none d-sm-table-cell text-center fs-sm">27/07/2019</td>
                        <td class="d-none d-md-table-cell text-center fs-sm">
